...
{
    public class TaskUpdaterStatusCmd : Notifiable, IValidatable, ICommand
    {
        public Guid Id { get; private set; }
        public TaskStatusCmd Status { get; private set; }
        public TaskUpdaterStatusCmd(Guid id, TaskStatusCmd status)
        {
            Id = id;
            Status = status;
        }
        public bool ShouldStatusBeChangedToDone()
        {
            return Status == TaskStatusCmd.DONE;
        }
